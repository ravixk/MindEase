...
videos = {
    ...
    "depressed": "https://www.youtube.com/watch?v=3pNpHZ1yv3I",
    ...
    "suicide": "http://www.aasra.info/helpline.html"
}
...
class MentalHealthChatbotApp(QMainWindow):
    ...
    def Speech_Input_Prediction(self):
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                self.response_textEdit.setPlainText('')
    ...
    def model_response(self, query):
        ...
        self.response_textEdit.setPlainText(random_response)
